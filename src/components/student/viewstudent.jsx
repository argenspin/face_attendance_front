...
function ViewStudent(props){
    const [data,setData] = useState({'id':props.data['id'], 'name':props.data['name'],'stud_class_name':props.data['stud_class_name'],'face_photo_b64':props.data['face_photo_b64'],'register_no':props.data['register_no'],'dob':props.data['dob']});
